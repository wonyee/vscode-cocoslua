...
(function (root, name, factory) {
  ...
  var ast = exports.ast = {
    ...
    , classStatement: function(identifier, base) {
      return {
    ...
    , assignmentStatement: function(variables, init) {
      if (init[0].type === 'FunctionDeclaration') {
        return {
            type: 'FunctionDeclaration'
          , identifier: variables[0]
          , parameters: init[0].parameters
          , body: init[0].body
        };
      }
      else {
  ...
  function parseClass() {
    ...
    if (token.value == ','){
      ...
      consume(')');
      return finishNode(ast.classStatement(identifier, str));
    } else {
      consume(')');
    }
    return finishNode(ast.classStatement(identifier, ''));
  }
        ...
        if (consume('function')) {
          ...
          do {
            ...
            if (expression.type == "ClassDeclaration"){
              variables.pop();
              return finishNode(ast.classStatement(expression.identifier, expression.base));
            }
            else{
    ...
    if (',='.indexOf(token.value) >= 0) {
      ...
      if (options.scope) {
        if (variables.length>0 &&
            ...
            variables[0].base.identifier &&
            variables[0].base.identifier.name === 'exports'){
          globals.push(variables[0].identifier);
        }
      }
